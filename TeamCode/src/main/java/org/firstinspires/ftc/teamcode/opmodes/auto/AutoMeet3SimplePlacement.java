...
@Autonomous(name = "Auto Meet 3 Simple Placement", preselectTeleOp = "MainTeleop", group = "a")
public class AutoMeet3SimplePlacement extends LinearOpMode{
    ...
    private static AutoMeet3SimplePlacement.START_POSITION startPosition = AutoMeet3SimplePlacement.START_POSITION.UNKNOWN; //WHERE WE ARE ON THE FIELD/ RED CLOSE ETC
    ...
    public void selectStartingPosition() {
        ...
        while (!positionFound && !isStopRequested()) {
            ...
            if (gamepad1.dpad_up || gamepad2.dpad_up) {
                startPosition = AutoMeet3SimplePlacement.START_POSITION.BLUE_CLOSE;
                AllianceHelper.alliance = AllianceHelper.Alliance.BLUE;
                positionFound = true;
            }
            if (gamepad1.dpad_down || gamepad2.dpad_down) {
                startPosition = AutoMeet3SimplePlacement.START_POSITION.BLUE_FAR;
                AllianceHelper.alliance = AllianceHelper.Alliance.BLUE;
                positionFound = true;
            }
            if (gamepad1.dpad_left || gamepad2.dpad_left) {
                startPosition = AutoMeet3SimplePlacement.START_POSITION.RED_FAR;
                AllianceHelper.alliance = AllianceHelper.Alliance.RED;
                positionFound = true;
            }
            if (gamepad1.dpad_right || gamepad2.dpad_left) {
                startPosition = AutoMeet3SimplePlacement.START_POSITION.RED_CLOSE;
                AllianceHelper.alliance = AllianceHelper.Alliance.RED;
                positionFound = true;
            }
            telemetry.update();
