...
public final class PoseHelper {
    ...
    public final static Pose2d farSpikeCenterRed = new Pose2d(-40.5,-34.5, Math.toRadians(90.0));
    ...
    public final static Pose2d apriltagStackRed = new Pose2d(-57.5, -35, Math.toRadians(180.0));
    ...
    public final static Pose2d apriltagStackBlue = new Pose2d(-57.5, 35, Math.toRadians(180.0));
