...
public final class PoseHelper {
    ...
    public final static Pose2d backboardLeftRed = new Pose2d(48, -26.9, Math.toRadians(180.0));
    public final static Pose2d backboardCenterRed = new Pose2d(48, -32.7, Math.toRadians(180.0));
    public final static Pose2d backboardRightRed = new Pose2d(48, -38.4, Math.toRadians(180.0));
