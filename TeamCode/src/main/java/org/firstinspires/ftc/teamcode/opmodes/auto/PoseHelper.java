...
public final class PoseHelper {
    ...
    public static Pose2d backboardLeftRed = new Pose2d(50, -29, Math.toRadians(180.0));
    public static Pose2d backboardCenterRed = new Pose2d(50, -35, Math.toRadians(180.0));
    public static Pose2d backboardRightRed = new Pose2d(50, -41, Math.toRadians(180.0));
    ...
    public static Pose2d farSpikeLeftRed = new Pose2d(-46.5, -39.5, Math.toRadians(80.0));
    ...
    public static Pose2d wingTrussInsideRed = new Pose2d(-33, -11, Math.toRadians(180.0));
    public static Pose2d boardTrussInsideRed = new Pose2d(17, -11, Math.toRadians(180.0));
    public static Pose2d parkPoseInsideRed = new Pose2d(58.5, -11, Math.toRadians(180.0));
    public static Pose2d parkPoseOutsideRed = new Pose2d(58.5, -59, Math.toRadians(180.0));;

    // BLUE POSES
    public static Pose2d initCloseBlue = new Pose2d(16, 63, Math.toRadians(270));
    public static Pose2d initFarBlue = new Pose2d(-33, 63, Math.toRadians(270));
    public static Pose2d backboardLeftBlue = new Pose2d(50, 41, Math.toRadians(180.0));
    public static Pose2d backboardCenterBlue = new Pose2d(50, 35, Math.toRadians(180.0));
    public static Pose2d backboardRightBlue = new Pose2d(50, 29, Math.toRadians(180.0));
    public static Pose2d farSpikeRightBlue = new Pose2d(-48.5, 39.5, Math.toRadians(-80.0));
    public static Pose2d farSpikeCenterBlue = new Pose2d(-40.5,34.5, Math.toRadians(90.0));
    public static Pose2d farSpikeLeftBlue = new Pose2d(-29, 36, Math.toRadians(-50.0));
    public static Pose2d closeSpikeRightBlue = new Pose2d(10.5, 30, Math.toRadians(180));
    public static Pose2d closeSpikeCenterBlue = new Pose2d(20.5, 24, Math.toRadians(180));
    public static Pose2d closeSpikeLeftBlue = new Pose2d(32.5, 30, Math.toRadians(180));
    ...
    public static Pose2d wingTrussInsideBlue = new Pose2d(-33, -11, Math.toRadians(180.0));
    public static Pose2d boardTrussInsideBlue = new Pose2d(17, -11, Math.toRadians(180.0));
    public static Pose2d parkPoseInsideBlue = new Pose2d(58.5, -11, Math.toRadians(180.0));
    public static Pose2d parkPoseOutsideBlue = new Pose2d(58.5, -59, Math.toRadians(180.0));;
//
