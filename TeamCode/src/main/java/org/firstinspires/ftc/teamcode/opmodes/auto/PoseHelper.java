...
public final class PoseHelper {
    ...
    public final static Pose2d farSpikeLeftRed = new Pose2d(-46.5, -38.5, Math.toRadians(135.0));
    ...
    public final static Pose2d farSpikeLeftBlue = new Pose2d(-29, 36, Math.toRadians(-135.0));
