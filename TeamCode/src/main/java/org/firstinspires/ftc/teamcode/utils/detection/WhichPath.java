...
//        Core.add(lowMat, highMat, workingMatrix);
        ...
        Imgproc.line(input, new Point(800/3.0,0), new Point(800/3.0,448), new Scalar(255,0,0), 3);
        Imgproc.line(input, new Point(2*800/3.0,0), new Point(2*800/3.0,448), new Scalar(255,0,0), 3);
