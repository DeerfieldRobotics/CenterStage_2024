...
class OuttakeKotlin (hardwareMap: HardwareMap, private var slide: SlideKotlin) {
    ...
    private var armInAngle = -117.147559 //angle of arm when it is in the robot TODO
    ...
    private var wristInAngle = 0.0 //angle of wrist when it is in the robot TODO
    private var wristOutAngle = -30.0 //angle of wrist when it is out of the robot
    ...
    fun getOuttakeAngle(): DoubleArray { //get position of arm and wrist servos
        return doubleArrayOf(currentArmAngle, wristStartAngle + (wristEndAngle - wristStartAngle) * wristServo.position)
    }
